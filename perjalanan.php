    ...
    <div id="app">
        ...
        <div class="main-content container-fluid">
            ...
            <section class="section">
                ...
                $suhu = 100;
                if($suhu >=37){
                  echo "<label class='btn btn-danger btn-icon-split btn-sm'><span=class'icon text-white-50'><i class='fas fa-question'></i></span><span class='text'>Tidak Normal</span></label>";
               
              }else if ($suhu <= 1 && $suhu <= 36){
                  echo "<label class='btn btn-success btn-icon-split btn-sm'><span='icon text-white-50'><i class='fas fa-check'></i></span><span class='text'>Normal</span></label>";
               } else {
                  echo "null";
                }
                // print "echo";
