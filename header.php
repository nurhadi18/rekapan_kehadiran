...
<head>
    ...
    <title>Rekapan Kehadiran Guru</title>
                    ...
                    <ul class="navbar-nav d-flex align-items-center navbar-light ml-auto">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="index.php"><i data-feather="user"></i> Account</a>
                                <a class="dropdown-item active" href="index.php"><i data-feather="mail"></i> Messages</a>
                                <a class="dropdown-item" href="index.php"><i data-feather="settings"></i> Settings</a>
