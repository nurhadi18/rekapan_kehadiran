 <div id="app">
    ...
    <div class="sidebar-header">
        <img  src="assets/images/logo.svg" type="image/gallery" width="" height="" >
    </div>
    <div class="sidebar-menu">
        <ul class="menu">
            
            
                <li class='sidebar-title'><u>Main Menu</u></li>
                ...
                <li class="sidebar-item  ">
                 ...
                 <li class="sidebar-item  ">
                    <a href="perjalanan.php" class='sidebar-link'>
                 ...
                 <li class="sidebar-item  ">
                    <a href="print/lap_perjalanan.php" class='sidebar-link'>
                        <i data-feather="save" width="20"></i> 
                        <span>Cetak Perjalanan</span>
                    </a>
                </li>
